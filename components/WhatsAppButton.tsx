...
const WhatsAppButton: React.FC = () => {
  return (
    <a
      href="https://wa.aisensy.com/aaatfq"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg shadow-green-500/20 hover:scale-110 hover:shadow-green-500/40 transition-all duration-300 group animate-bounce-slow"
